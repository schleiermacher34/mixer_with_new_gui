...
void ui_Screen1_screen_init(void)
{
    ...
    lv_obj_set_width(ui_modebutton, 422);
    ...
    lv_obj_set_width(ui_rotationbutton, 422);
    ...
    lv_obj_set_width(ui_speedchange, 422);
    ...
    lv_obj_set_width(ui_modebutton4, 422);
    lv_obj_set_height(ui_modebutton4, 132);
    lv_obj_set_x(ui_modebutton4, 183);
    ...
    lv_obj_set_width(ui_modebutton5, 422);
    ...
    ui_Label1111 = lv_label_create(ui_Panel11);
    lv_obj_set_width(ui_Label1111, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_Label1111, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_Label1111, 20);
    lv_obj_set_y(ui_Label1111, 0);
    lv_obj_set_align(ui_Label1111, LV_ALIGN_CENTER);
    lv_label_set_text(ui_Label1111, "1");
    lv_obj_set_style_text_color(ui_Label1111, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_Label1111, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_Label1111, &lv_font_montserrat_46, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_modebutton7, 422);
    ...
    lv_obj_set_width(ui_customsetupbutton, 422);
    ...
    ui_Label2222 = lv_label_create(ui_Panel15);
    lv_obj_set_width(ui_Label2222, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_Label2222, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_Label2222, 7);
    lv_obj_set_y(ui_Label2222, 0);
    lv_obj_set_align(ui_Label2222, LV_ALIGN_CENTER);
    lv_label_set_text(ui_Label2222, "1");
    lv_obj_set_style_text_color(ui_Label2222, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_Label2222, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_Label2222, &lv_font_montserrat_46, LV_PART_MAIN | LV_STATE_DEFAULT);
